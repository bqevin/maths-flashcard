...
while($row=mysql_fetch_array($result_set))
{
    ...
    $audio_number = $row['audionumber'] ;
     ...
     echo "uploads/".$number_image;

    echo '<h1><img src="uploads/'.$number_image.'"></h1>';
}
*/
           ...
           <?php
            ...
            while($row1=mysql_fetch_array($result_set1))
            {
                ...
                setInterval(function(){
                    var data = <img src="'<?php echo 'uploads/'.$number_image; ?>'">; document.getElementById("display").innerHTML  = data;
                },3000);
            </script>
                        </div>';

                        echo "<audio autoplay>"."<source src='uploads/".$audio_number."'type='audio/mpeg'> </audio> ";
